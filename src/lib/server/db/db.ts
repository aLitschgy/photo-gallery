...
// En dev: /app/src/lib/server/db/photos.json
// En prod (Docker): /app/gallery-data/data/photos.json (via symlink)
const DB_PATH =
  process.env.DB_PATH ||
  path.join(process.cwd(), "src/lib/server/db/photos.json");
